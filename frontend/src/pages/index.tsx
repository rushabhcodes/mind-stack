...
const features = [
  {
    icon: '🔗',
    title: 'Save Any Link',
    description: 'Store YouTube videos, Twitter threads, articles, and any web content in one click. Beautiful previews and instant access.',
    color: '#3b82f6'
  },
  {
    icon: '📝',
    title: 'Quick Notes',
    description: 'Jot down thoughts, ideas, and reminders with rich formatting and instant search. Never lose an idea again.',
    color: '#06b6d4'
  },
  {
    icon: '🏷️',
    title: 'Organize Effortlessly',
    description: 'Auto-categorize your content with tags, collections, and powerful filters. Find what you need, fast.',
    color: '#8b5cf6'
  },
  {
    icon: '🔄',
    title: 'Sync Everywhere',
    description: 'Access your content anywhere, anytime. Perfect sync across all devices with offline support.',
    color: '#10b981'
  }
];
  ...
  const slides = [
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p style={{
          ...
          The most elegant way to save links, videos, tweets, and notes.<br />
        ...
        <button
          ...
          onMouseEnter={e => {
            ...
            (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 12px 36px rgba(99,102,241,0.22)';
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLButtonElement).style.transform = '';
            (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 6px 24px rgba(99,102,241,0.18)';
          }}
        >
    ...
    >
      ...
      <div style={{
        ...
        width: '100%',
        height: 8,
        background: 'linear-gradient(270deg, #6366f1, #38bdf8, #06b6d4, #6366f1)',
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            color: '#3b82f6',
            boxShadow: '0 2px 8px rgba(59, 130, 246, 0.08)',
            cursor: featureIndex === features.length - 1 ? 'not-allowed' : 'pointer',
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%' }}>
        ...
        <p style={{
          ...
          Help us make <span style={{ color: '#6366f1', fontWeight: 600 }}>Mind Stack</span> better! Share your thoughts, suggestions, or report any issues. Your feedback shapes the future of our product.
        </p>
        <form
          style={{
        ...
        >
          <input
            ...
            onBlur={e => (e.currentTarget.style.border = '1.5px solid #e0e7ef')}
          />
          <textarea
            required
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 8px 24px rgba(99,102,241,0.18)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.transform = '';
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 18px rgba(99,102,241,0.13)';
            }}
          >
            Submit Feedback
          </button>
